...
template<typename T>
class Matrix4L : public Matrix4Base<T> {

public:
	Matrix4L(int l1, int h1, int l2, int h2, int l3, int h3, int l4, int h4, randomize<T> randomizer) 
		: Matrix4Base<T>(l1, h1, l2, h2, l3, h3, l4, h4, randomizer) {
		this->D4 = 1;
		this->D3 = (this->h4 - this->l4 + 1) * this->D4;
		this->D2 = (this->h3 - this->l3 + 1) * this->D3;
		this->D1 = (this->h2 - this->l2 + 1) * this->D2;
	}
